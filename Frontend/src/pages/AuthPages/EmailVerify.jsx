            ...
            <div className="_2 flex-wrapper-copy">
              <Link to="/login" className="branding w-nav-brand">
                <img
                  ...
                  // srcSet="https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-500.png 500w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-800.png 800w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-1080.png 1080w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24).png 1080w"
                  alt=""
                />
              </Link>
              <nav role="navigation" className="nav-menu-3 w-nav-menu">
                              ...
                              <div className="dropdown-column third">
                                ...
                                >
                                  ...
                                  <div className="dropdown-card-content">
                                    ...
                                    <p className="dropdown-card-text">
                                      Para que la gestión de proyectos y tareas sea más sencilla. Gratis para equipos de
                                ...
                                >
                                  ...
                                  <div className="dropdown-card-content">
                                    ...
                                    <p className="dropdown-card-text">
                                      Para la gestión de iniciativas a gran escala y la mejora de la colaboración entre
                                      los equipos.
                                    </p>
                                  </div>
                                </a>
                                ...
                                >
                                  ...
                                  <div className="dropdown-card-icon arrow w-embed">
                                    <svg viewBox="0 0 14 11" preserveAspectRatio="xMinYMin" style={{ fill: '#646f79' }}>
                                      <path
                                        fillRule="evenodd"
                ...
                <div className="relative-block">
                  ...
                  <div className="cta-navbar after">
                    <a href="#" data-w-id="fc84a43c-8b33-26aa-174f-6d036da2ae8b" className="nav-link-black w-nav-link">
                      Contact Sales
                    </a>
                    <Link
                      to="/login"
        ...
        <div className="container w-container">
          <div className="sign-in-form-container---brix preview-page">
            <div className="sign-in-form-wrapper---brix">
              <div className="sign-in-form-block---brix sign-in-v3---brix w-form">
                <div
                  id="wf-form-Sign-up-Form"
                  name="wf-form-Sign-up-Form"
                  data-name="Sign up Form"
                  className="sign-in-form-v2---brix"
                >
                  <div className="title-container---brix bt30">
                    <Link href="/login" className="maxw-170 w-inline-block">
                      <img
                        width="80%"
                        sizes="(max-width: 479px) 100vw, 170px"
                        src="/assets/icons/email-verification.png"
                        loading="lazy"
                        alt=""
                      />
                    </Link>
                    {/* <Typography className="heading-32 font-inter mt-60" color="rgb(177, 59, 237)"> */}
                    <Typography fontWeight={700} className="heading-32" color="rgb(177, 59, 237)" marginTop={6}>
                      Verify your email
                    </Typography>
                    <Typography color={'black'} textAlign={'left'} marginTop={5}>
                      We sent an email with a link to verify your registration.
                    </Typography>
                    <br />
                    <Typography color={'black'} textAlign={'left'}>
                      Please check your <strong>spam folder</strong> if you don't see it in your inbox.
                    </Typography>
                  </div>
                </div>
              </div>
