...
const Login = () => {
  ...
  const { user, login, isAuthLoading } = useUser();
  ...
  useEffect(() => {
    if (user) navigate('/email-accounts');
  }, [navigate, user]);
            ...
            <div className="sign-in-form-container---brix preview-page">
              <div className="sign-in-form-wrapper---brix">
                <div className="sign-in-form-block---brix sign-in-v3---brix w-form full-opacity">
                  <div className="sign-in-form-v2---brix">
                    <div className="title-container---brix bt30">
                      <Link to="/" className="maxw-170 w-inline-block">
                        <img
                          width="200"
                          sizes="(max-width: 479px) 100vw, 170px"
                          // src="https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24).png"
                          src="/assets/images/screens (24).png"
                          loading="lazy"
                          // srcSet="https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-500.png 500w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-800.png 800w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24)-p-1080.png 1080w, https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/63c15fe5a8036c3c7db6af56_screens%20(24).png 1080w"
                          srcSet="/assets/images/screens-500.png 500w, /assets/images/screens-800.png 800w, /assets/images/screens-1080.png 1080w,  /assets/images/screens (24).png 1080w"
                      ...
                      <h1 className="heading-32 font-inter mt-60">Sign in</h1>
                      <p className="pra-16 mt-10">
                        {/* Don&#x27;t have an account yet?
                        <br />‍
                        <a href="https://app.baremetrics.com/users/sign_up" className="link-5">
                    ...
                    <Link to="/forgot-password" className="link-pass mt-10">
                      Forgot your password?
                    </Link>
                    <input
                      onClick={submit}
                      type="submit"
                      value={isAuthLoading.login ? 'Loading...' : 'LOGIN'}
                      data-wait="Please wait..."
                      className="btn-login mt-15 w-button"
                      style={{ backgroundColor: isAuthLoading.login ? '#DBDADA' : '' }}
                      disabled={isAuthLoading.login}
                    />
                    <div className="text-12 mt-30">
                      Not registered yet?{' '}
                      <Link to="/signup" className="link-pass">
                        Sign up
                      </Link>
                    </div>
                    {/* <img
                      src="/assets/icons/cross.svg"
                      // src="https://uploads-ssl.webflow.com/639ca3bff74e755905243b32/6413023adef53d6573559a4d_%E2%86%B3Color.svg"
                      loading="lazy"
                      alt=""
                      className="_w-20 position"
                    /> */}
                  </div>
