    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @endif
                @if($errors->has('url'))
                    <div class="alert alert-danger col-12">{{ $errors->first('url') }}</div>
                @endif
                @if(session('error'))
            ...
            <div class="card">
                <div class="card-body table-responsive p-0">
                    ...
                    <table class="table table-head-fixed text-nowrap">
                        ...
                        <tr>
                            <td>#</td>
                            <td>{{ @$unsubscribeLink->url }}</td>

                            <td>
                                <button class="btn btn-success btn-sm edit_template"
                                        data-template="{{ json_encode($unsubscribeLink) }}"><i class="fas fa-edit"></i>
                                </button>
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="edit_template" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.unsubscribe.link')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="col-md-12">
                            <label>Link</label>
                            <input type="text" name="url" class="form-control edit_url" required>
