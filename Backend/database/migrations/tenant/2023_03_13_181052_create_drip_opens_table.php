...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('drip_opens', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('smtp_id')->constrained('email_accounts')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('drip_opens');
    }
};
